var app = angular.module('ownerUploadModel', ['toastr']);
app.controller('ownerUploadCtrl', function($scope,ownerSer,$state,toastr,$stateParams,$http){
    $scope.files = [];
    $scope.affirmFile = [];
    var oldFiles = [];
    //删除文件
