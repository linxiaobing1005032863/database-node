...
app.controller('viewCtrl', function($scope, ownerSer,$stateParams,$state,toastr,){
    var data = {
        id:$stateParams.id,
        token:$stateParams.tonken
    };
    ownerSer.ownerView(data).then(function (response) {
    ...
    $scope.editFun = function () {
        ownerSer.editRange(data).then(function (response) {
