var app = angular.module('siteUploadModel', ['toastr']);
app.controller('siteUploadCtrl', function($scope,siteSer,$state,toastr,$stateParams,$http){
    $scope.files = [];
    $scope.affirmFile = [];
    var oldFiles = [];
    //删除文件
    ...
    $scope.siteNameChanged = function () {
